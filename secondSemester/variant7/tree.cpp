...
// тут плохо работает удаление элемента
...
*/
// âîçâðàùàåò èíôîðìàöèþ åñòü ëè ó íàñ ýòîò ýëåìåíò
void seachElement(Tree* branch, int value) {
...
// âîçâðàùàåò óêàçàòåëü íà ýëåìåíò êîòîðûé ìû èùåì
Tree* treeSearch(Tree* branch, int value) {
...
// öåíòðèðîâàííûé îáõîä äåðåâà, ñòîèò ïî óìîë÷àíèþ
void inorderTreeWalk(Tree* branch){
	if (branch != NULL) {
...
// ôóíêöèÿ êîòîðàÿ ìåíÿåò ìåñòàìè äåðåâüÿ
void transplant(Tree*& branch, Tree* replaceableBranch, Tree* branchSubstitute) {
